...
public class Order {
	...
	public void setQuantity(int quantity) {
		if(quantity > 0) {
			...
			System.out.println("Attemping to set the  qquantity to a value less than or equal to zero");
		}
	}
	...
	private boolean isHolday(MyDate proposedDate) {
